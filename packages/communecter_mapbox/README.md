...
## Install
    ...
    $ meteor add communecter:mapbox@2.2.3_2

or (if you want to modify the code):

    $ cd to/my/meteor/project
    $ mkdir packages # ensure that packages folder exists
    $ git clone https://github.com/pauloborges/meteor-mapbox.git packages/communecter:mapbox
    $ meteor add communecter:mapbox
